...
## NOTE: THIS PROJECT IS OUTDATED AND HAS A *VERY* SUBPAR CODEBASE RELATIVE TO MY SKILLS NOW (in my opinion). I MAY GET BACK TO THIS AT SOME POINT BUT IF YOU ARE A RESEARCHER/STUDENT LOOKING AT THIS YOU ARE LIKELY BETTER SERVED BY EXPORTING .GCODE FILES AS INSTRUCTUION SETS TO YOUR PRINTER VIA ULTIMAKER OR SOME OTHER SLICER AND MODIFYING HEADERS AS NEEDED. 
